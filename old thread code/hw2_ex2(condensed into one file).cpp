...
//
//Description:  Producer / Consumer problem.  n producers produce x integers 
//and m
...
int main(int argc, char *argv[]){
	...
	if((g_iIntsPerProducer = atoi(argv[3])) < 2){
		cout << "numIntegers < 2; producer must add at least 2 integers" << endl;
		exit(-1);
	}
